...
using Manta.Projections.Installer;
...
{
    /// <inheritdoc />
    public class MsSqlProjectorsInstaller : ProjectorsInstaller
    {
        private readonly string _connectionString;
        private readonly ILogger _logger;

        public MsSqlProjectorsInstaller(string connectionString, ILogger logger = null)
        {
